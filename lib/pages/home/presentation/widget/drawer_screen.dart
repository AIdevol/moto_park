...
//               Text(
//                 "Rate App",
//                 style: BalooStyles.baloomediumTextStyle(color: Colors.black87, size: 25),
//               ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        child: Text("Rate Now",style: BalooStyles.baloomediumTextStyle(color: Colors.black87, size: 15)),
                        onPressed: () {
                          // Open respective store link for rating
                          // If Android
                          // LaunchReview.launch(androidAppId: packageName);
                      ...
                      ElevatedButton(
                        child: Text("Later", style: BalooStyles.baloomediumTextStyle(color: Colors.black87, size: 15),),
                        onPressed: () {
                          Navigator.of(context).pop();
                        },
                        style: ElevatedButton.styleFrom(
